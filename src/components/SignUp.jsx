        ...
        <div className="max-w-md mx-auto">
          ...
          <form onSubmit={handleSignUp} className="divide-y divide-gray-200">
            <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              ...
              <p>If have an account, Please <Link to="/login" className="text-blue-500 underline">Login</Link> here.</p>
              <div className="relative">
          ...
          <button onClick={handleGmailSignUp}><img src={gmail} alt="" className='text-sm w-7 h-7 inline-block rounded-full text-center' /> Login with Gmail</button>
          </div>
        </div>
      </div>
    </div>
